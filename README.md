...
*Note*:
  ...
  + The library requires a license to work. However, when no license is specified in the code, a [free public trial license](https://www.dynamsoft.com/license-server/docs/about/terms.html?ver=latest#public-trial-license?utm_source=github&product=dlr&package=js) will be applied. You can make initial evaluation of the library to decide whether or not you want to evaluate it further. If you do want more evaluation time, you can [request a trial](#requesting-a-trial).
...
* In most cases, online licenses are offered. If you want to use an offline license, you can [contact us](https://www.dynamsoft.com/company/contact/?utm_source=github).
* If nothing is specified like the above "hello world" example, a [free public trial license](https://www.dynamsoft.com/company/contact/?utm_source=github&product=dlr&package=js) will be automatically used. This license requires a network connection.
...
If no license is specified, a [free public trial license](https://www.dynamsoft.com/license-server/docs/about/terms.html?ver=latest#public-trial-license?utm_source=github&product=dlr&package=js) will be used by default. 
